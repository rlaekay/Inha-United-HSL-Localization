...
public:
  ...
  template <typename... Ts> inline void log(string_view entity_path, const Ts &...archetypes_or_collections) const {
    if (enable_log_tcp) { log_tcp.log(entity_path, archetypes_or_collections...); }

    if (enable_log_file) { log_file.log(entity_path, archetypes_or_collections...); }
  }
